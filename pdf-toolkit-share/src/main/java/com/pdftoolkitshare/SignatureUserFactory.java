...
public class SignatureUserFactory extends SlingshotUserFactory {
	public static String SCP_SIGNATURE_PIN = "{http://www.alfresco.com/model/pdftoolkit/1.0}signaturepin";
	public static String PROP_SCP_SIGNATURE_PIN = "signaturepin";
    ...
    protected AlfrescoUser constructUser(JSONObject properties, Map<String, Boolean> capabilities,
        ...
        user.setProperty(PROP_SCP_SIGNATURE_PIN, properties.has(SCP_SIGNATURE_PIN) ? properties.getString(SCP_SIGNATURE_PIN) : null);
        return user;
    }
    ...
    public void saveUser(AlfrescoUser user) throws UserFactoryException {
        ...
        try {
            ...
            writer.writeValue(SCP_SIGNATURE_PIN, user.getStringProperty(PROP_SCP_SIGNATURE_PIN));
